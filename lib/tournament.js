...
// ============================================================
// ── DÍA ACTIVO ──────────────────────────────────────────────
// Cambiá este número al id del matchday que querés mostrar en la landing.
export const CURRENT_MATCHDAY_ID = 2;
// --- JUGADORES -----------------------------------------------
...
export const MATCHES = [
  ...
  { id:"C2", stage:"group", group:"C", matchdayId:1, home:"P11", away:"P12", time:"23:40",
    homeScore:0, awayScore:2,
    homeGoals: [],
    awayGoals: ["Darwin Núñez", "Darwin Núñez"],
    homeCards: [],
    awayCards: [{ player: "J. M. Giménez", type: "red" }], },

  // ── FECHA 1 — DOM 05/07  ─────────────────  
  { id:"D1", stage:"group", group:"D", matchdayId:2, home:"P13", away:"P14", time:"22:00",
    homeScore:4, awayScore:1,
    homeGoals: ["Martin Ødegaard", "Martin Ødegaard", "Oscar Bobb", "Antonio Nusa"],
    awayGoals: ["Ayoud el Kaabi"],
    homeCards: [],
    awayCards: [], 
  },
  { id:"E1", stage:"group", group:"E", matchdayId:2, home:"P17", away:"P18", time:"22:20",
    homeScore:0, awayScore:0,
    homeGoals: [],
    awayGoals: [],
    homeCards: [],
  ...
  { id:"E2", stage:"group", group:"E", matchdayId:2, home:"P19", away:"P20", time:"22:40",
    homeScore:0, awayScore:3,
    homeGoals: ["NO SE PRESENTO"],
    awayGoals: [],
    homeCards: [],
    awayCards: [],
  },
  { id:"F1", stage:"group", group:"F", matchdayId:2, home:"P21", away:"P22", time:"23:00",
    homeScore:1, awayScore:1,
    homeGoals: ["Roberto Alvarado"],
    awayGoals: ["Keito Nakamura"],
    homeCards: [],
    awayCards: [], },
  { id:"F2", stage:"group", group:"F", matchdayId:2, home:"P23", away:"P24", time:"23:20",
    homeScore:3, awayScore:0,
    homeGoals: [],
    awayGoals: ["NO SE PRESENTO"],
    homeCards: [],
    awayCards: [], 
  },
  { id:"D2", stage:"group", group:"D", matchdayId:2, home:"P15", away:"P16", time:"23:40",
    homeScore:3, awayScore:0,
    homeGoals: ["Carney Chukwuemeka", "Alexander Prass", "Marko Arnautović"],
    awayGoals: [],
    homeCards: [],
    awayCards: [],  },
